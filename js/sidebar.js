// If someone lands on the github.io address, send them to the real domain.
// Guarded to the github.io hostname, so it never redirects on mikibutler.ca
// (no loop, no DNS/CNAME involved).
if (location.hostname.endsWith('github.io')) {
  location.replace('https://mikibutler.ca' + location.pathname + location.search + location.hash);
}
